...
import { TRIP_CATEGORIES, CreateTripData, TripItineraryDay, TripItineraryItem, TripGalleryImage } from '@/types/trip';
    ...
    <AdminLayout>
      ...
      >
        ...
        <div className="space-y-6">
          ...
          {/* Other tabs content would be here - kept basic for now */}
          {activeTab === 'itinerary' && (
            <motion.div
              key="itinerary"
              initial={{ opacity: 0, x: 20 }}
