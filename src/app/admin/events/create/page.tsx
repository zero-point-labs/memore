...
import { EVENT_TYPES, EVENT_CITIES, CreateEventData, EventType, EventCity } from '@/types/event';
...
export default function CreateEventPage() {
    ...
    try {
      ...
      const createData: CreateEventData = {
        ...
        capacity: {
          ...
          generalTaken: 0,
          vipTaken: 0,
          generalRemaining: formData.generalCapacity,
          vipRemaining: formData.vipCapacity,
        },
        eventContent: {
          ...
          featuredImage: formData.featuredImage || 'placeholder-event-image',
  ...
  const addToList = (listName: 'includes' | 'highlights' | 'lineup' | 'category', value: string) => {
  ...
  const removeFromList = (listName: 'includes' | 'highlights' | 'lineup' | 'category', index: number) => {
    setFormData(prev => ({
      ...prev,
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400">Add a new single-night event</p>
            </div>
          </div>
          <motion.button
        ...
        <div className="bg-black/40 border border-purple-500/20 rounded-2xl p-8">
          <div className="space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Summer Beach Party at Castle Club"
                  />
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-black/40 border border-purple-500/20 rounded-lg text-white focus:outline-none focus:border-purple-500/60"
                    placeholder="Castle Club Ayia Napa"
                  />
                </div>
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-300 mb-2">Venue Address</label>
                <input
                  type="text"
                  value={formData.venueAddress}
                  onChange={(e) => setFormData({...formData, venueAddress: e.target.value})}
                  className="w-full px-4 py-3 bg-black/40 border border-purple-500/20 rounded-lg text-white focus:outline-none focus:border-purple-500/60"
                  placeholder="123 Beach Road, Ayia Napa"
                />
              </div>
            </div>
            ...
            {/* Lineup */}
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-white border-b border-purple-500/20 pb-3">Artist Lineup (Optional)</h3>
              <p className="text-gray-400 text-sm">For DJ names, performers, or special guests</p>
            </div>
