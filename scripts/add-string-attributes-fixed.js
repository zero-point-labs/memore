...
async function addStringAttributesFixed() {
  try {
    console.log('Adding string attributes with correct parameters...');
    ...
    try {
      ...
      if (error.code === 409) {
        ...
        try {
          ...
          console.log('✅ Created attribute: rating (string, no default)');
        } catch (error2) {
          console.log('❌ Error creating rating (string, no default):', error2.message);
        }
      }
    }
    ...
    try {
      ...
      if (error.code === 409) {
        ...
        try {
          ...
          console.log('✅ Created attribute: published (string, no default)');
        } catch (error2) {
          console.log('❌ Error creating published (string, no default):', error2.message);
        }
      }
    }
    ...
    try {
      ...
      if (error.code === 409) {
        ...
        try {
          ...
          console.log('✅ Created attribute: featured (string, no default)');
        } catch (error2) {
          console.log('❌ Error creating featured (string, no default):', error2.message);
        }
      }
    }
